...
namespace Sc.Util.Rendering
{
	...
	public static class SimpleColorTransforms
	{
		...
		/// </summary>
		/// <param name="color">The color to convert.</param>
		/// <returns> { H: [0, 360], S: [0, 1], B: [0, 1] }</returns>
		...
		/// Alpha is used.</param>
		/// <returns>RGB Color.</returns>
		public static Color TransformValue(
				Color color,
		...
		/// transformation value is added to the current hue (in [0, 360]); and
		/// the output will be rotated to within [0, 360] (does not raise exceptions).
		/// ALSO multiplies the Color's Saturation, and Luminance or Brightness by the arguments;
		/// and optionally specifies the output Alpha.
		/// </summary>
		/// <param name="color">The color to transform.</param>
		/// <param name="hueTransform">The transformation to apply to this
		...
		/// Alpha is used.</param>
		/// <returns>RGB Color.</returns>
		public static Color TransformHueSaturationAndValue(
				Color color,
				ColorTransformMode colorTransformMode,
				double hueTransform,
				double saturationTransform,
